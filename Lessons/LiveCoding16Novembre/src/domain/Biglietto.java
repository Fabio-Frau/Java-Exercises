...
public class Biglietto {
    ...
    public Biglietto(String id, String cittaPartenza, String cittaDestinazione,
                     OffsetDateTime dataPartenza, OffsetDateTime dataArrivo,
                     String posto, String gate, Aeromobile aeromobile) {
        this.id = id;
