public class Main {
    public static void main(String[] args) {
        ...
        Articolo article1 = new Articolo("Pizza Napoli", 3.99, 0.1, TipoArticolo.Cibo);
        Articolo article2 = new Articolo("Coca Cola", 0.99, 0.22, TipoArticolo.Bibita);
        Articolo article3 = new Articolo("Tiramisu", 2.49, 0.22, TipoArticolo.Cibo);
