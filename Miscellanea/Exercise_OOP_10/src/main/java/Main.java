...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Carolus Vitali", 11, new ArrayList<>());
        Student student2 = new Student("Nakeisha Uhuru", 10, new ArrayList<>());
        Student student3 = new Student("Gabriella Cherice", 10, new ArrayList<>());
